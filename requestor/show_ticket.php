...
if((int)$row["cc_member_id"]) $xtpl->assign("APPLICANT_ID", "<a href='https://support.ualadys.com/members.rpx?id={$row['cc_member_id']}' target='support'>".$row["cc_member_id"]."</a>".$golden);
